...
public class MapFragment extends Fragment implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        mMap = googleMap;
        final DetailRootFragment detailRootFragment = new DetailRootFragment();
        detailRootFragment.ads = Parse.Data.map;
        mMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            @Override
            public boolean onMarkerClick(Marker marker) {
                for (ParseObject ad : Parse.Data.map) {
                    if (ad.getObjectId().equals(marker.getSnippet())) {
                ...
                getFragmentManager().beginTransaction()
                        ...
                        .add(R.id.map, detailRootFragment)
                        .addToBackStack(null)
                        .commit();
                return false;
            }
        });
        getCoordinates(Parse.Data.map);
    }
